            ...
            foreach ($articles as $article) :; ?>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <div>
                                <a href="single-article.php?id-article=<?= $article['id_art'] ?>&from=1" class="btn btn-primary col-md-2"><i class="fa fa-eye" aria-hidden="true"></i>
                                </a>
                                <a href="update-article.php?art-update-id=<?= $article['id_art'] ?>" class="btn btn-success col-md-2"> <i class="fa fa-edit" aria-hidden="true"></i></a>
                                ...
                                <a href="back-commentaires.php?id-article=<?= $article['id_art'] ?>" class="btn btn-warning col-md-3"><i class="fa fa-comment mr-1" aria-hidden="true"></i><?= $com['nb_com'] ?></a>
