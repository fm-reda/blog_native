        ...
        <?php foreach ($coments as $coment) :; ?>
            <div class=" m-2 bg-white border shadow-sm">
                ...
                <div class="border-bottom mb-0">
                    <div class="row px-4 text-muted justify-content-between">
                        <div>
                        ...
                        <a href="traitement-article.php?com-del-id=<?= $coment['id_art'] ?>" class="btn btn-danger col-lg-2 h-25 mt-3"><i class="fa fa-trash mr-1" aria-hidden="true"></i></a>
                    </div>
                </div>
